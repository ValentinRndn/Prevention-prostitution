    ...
    <div class="content w-full">
      <div class="dashboard-container">
        <div class="update-keys mt-16">
          ...
          <div class="posts-keys flex flex-col gap-5 w-full bg-white p-4 mt-10 rounded-md shadow-xl font-poppins justify-center max-md:items-center max-md:w-full max-md:h-4/6">
            <h3 class="font-bold border-b border-b-solid border-light-grey pb-5 pt-2 text-center">Gérer mes articles</h3>
           
            <div v-for="article in paginatedArticles()" :key="article._id" :class="['post-field', { 'archived': article.archive }]" class="post-field flex w-full justify-between border-b border-b-solid border-light-grey pb-5 max-md:flex-col max-md:items-center">
