    ...
    <div class="dashboard-container">
      <div class="mt-20 max-md:mt-16 px-6 max-md:px-4">
        ...
        <div class="update-field flex w-full border-b border-b-solid border-light-grey pb-5 max-md:flex-col max-md:items-center">
          ...
          <input v-model="firstStats" class="border border-solid border-light-grey ml-auto shadow-lg w-[100px] text-center rounded-md max-md:mr-auto" type="number" name="updateNumber" id="first" maxlength="10">
        </div>

        <div class="update-field flex w-full border-b border-b-solid border-light-grey pb-5 max-md:flex-col max-md:items-center">
          <p>Seconde statistique</p>
          <input v-model="secondStats" class="border border-solid border-light-grey ml-auto shadow-lg w-[100px] text-center rounded-md max-md:mr-auto" type="number" name="updateNumber" id="second" maxlength="10">
        </div>

        <div class="update-field flex w-full border-b border-b-solid border-light-grey pb-5 max-md:flex-col max-md:items-center">
          <p>Troisième statistique</p>
          <input v-model="thirdStats" class="border border-solid border-light-grey ml-auto shadow-lg w-[100px] text-center rounded-md max-md:mr-auto" type="number" name="updateNumber" id="third" maxlength="10">
        </div>
