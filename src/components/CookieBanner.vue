<template>
    <div v-if="isVisible" class="cookie-banner fixed flex flex-col items-center gap-4 justify-center bottom-0 left-0 w-fit bg-purple-fonce text-white p-6 z-20 max-w-[450px] rounded-lg">
