    ...
    <div v-if="isVisible" class="cookie-banner fixed flex flex-col items-center gap-4 justify-center bottom-0 left-0 w-fit bg-lightpurple text-white p-6 z-60 max-w-[450px] rounded-lg">
      ...
      <div class="flex-col items-center justify-center gap-4 ">
        <div class="choices-container flex w-full gap-12 mb-8">
          <div class="accept-container flex items-center gap-2 bg-purple-fonce px-2 py-1 rounded w-fit rounded-r-full cursor-pointer" @click="acceptAll">
          ...
          <div @click="openSettings" class="refuse-container flex items-center justify-center gap-2 bg-purple-fonce px-2 py-1 rounded w-fit rounded-r-full cursor-pointer">
      ...
      <div v-if="showSettings" class="mt-4 p-4 rounded-lg text-purple-fonce  w-full">
        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="flex items-center gap-2">
            <input type="checkbox" id="performance" v-model="cookieSettings.performance" class="accent-purple-fonce" />
            <label for="performance" class="text-lg">Cookies de performance</label>
          </div>
          <div class="flex items-center gap-2">
            <input type="checkbox" id="functionality" v-model="cookieSettings.functionality" class="accent-purple-fonce" />
            <label for="functionality" class="text-lg">Cookies de fonctionnalité (carte interactive)</label>
          </div>
          <div class="flex items-center gap-2">
            <input type="checkbox" id="advertising" v-model="cookieSettings.advertising" class="accent-purple-fonce" />
